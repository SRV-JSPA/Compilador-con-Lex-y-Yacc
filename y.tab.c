...
static const yytype_int8 yyrhs[] =
{
      ...
      15,    -1,    16,    10,    -1,     4,     5,    16,    -1,     3,
      -1,     4,    -1,    16,     6,    16,    -1,    16,     7,    16,
      -1,    16,     8,    16,    -1,    16,     9,    16,    -1
};
...
#line 31 "simple_language.y"
    { std::cout << (yyvsp[(1) - (2)].num) << std::endl; }
    break;

  case 7:
#line 35 "simple_language.y"
    { 
        printf("Assign %s = %d\n", (yyvsp[(1) - (3)].str)->c_str(), (yyvsp[(3) - (3)].num)); 
        (yyval.num) = vars[*(yyvsp[(1) - (3)].str)] = (yyvsp[(3) - (3)].num); 
